  <div id="footer">
    <div class="container row">
      <div class="four_span">
        <a title="<?php bloginfo( 'name' ); ?> - Home" href="<?php home_url(); ?>" id="logo"><img src="<?php echo get_theme_mod( 'inverted_logo'); ?>" class="inverted_logo" alt="<?php bloginfo( 'name' ); ?> - Inverted Logo"></a>
